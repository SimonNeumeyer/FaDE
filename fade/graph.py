import numpy
from networkx import is_isomorphic as lib_is_isomorphic, DiGraph, draw_networkx
import json
...
class Graph():
    ...
    def _contain_from_technical(self, technical):
        ...
        for v in technical:
            edges.extend([(v, str(s)) for s in vertices[numpy.array(technical[v], dtype=bool)]])
